...
public interface ProfessorService {
    ...
    void grade(StudentGradeDto professorGradeDto) throws ServiceEntityAlreadyExistsException, ServiceForeignKeyNotFoundException, ServiceEntityNotFoundException;
