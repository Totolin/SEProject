...
INSERT INTO PERSON(ID, SSN, ADDRESS, EMAIL, FIRST_NAME, LAST_NAME, PHONE_NUMBER)
 ...
 VALUES(6, '1890811160031','Craiova', 'diana@yahoo.com','Diana','Micu','0778521542');
  INSERT INTO PERSON(ID, SSN, ADDRESS, EMAIL, FIRST_NAME, LAST_NAME, PHONE_NUMBER)
 VALUES(7, '1941116160066','Craiova', 'andrei.urdiniceanu@yahoo.com','Andrei','Urdiniceanu','0770525142');
...
INSERT INTO USER (ID, PASSWORD, STATE, TYPE_U, USERNAME) VALUES (7,'$2a$10$5ysE1CvqJLSXL5hFChyhFO4gwGIgYjaprBIcrxAgSfgJVhs0UVoTS', 'Active', 'STUDENT', 'andrei.urdiniceanu');


-- GROUPS
INSERT INTO GROUP_T(ID, NAME, SPECIALIZATION, YEAR) VALUES(1, '10305S','C.E.',3);
INSERT INTO GROUP_T(ID, NAME, SPECIALIZATION, YEAR) VALUES(2, '10305H','C.E.',3);

-- STUDENTS
INSERT INTO STUDENT(ID, GROUP_ID, SUBGROUP, PAID) VALUES (1, 1, 'B', 0);
INSERT INTO STUDENT(ID, GROUP_ID, SUBGROUP, PAID) VALUES (7, 2, 'B', 0);
...
INSERT INTO SUBJECT(ID, NAME, CREDITS) VALUES (3, 'Verification and testing', 4);
INSERT INTO SUBJECT(ID, NAME, CREDITS) VALUES (4, 'Database design', 1);
...
INSERT INTO STUDENT_SUBJECT(ID, GRADE, STUDENT_ID, SUBJECT_ID) VALUES (3,null,7,3);
INSERT INTO STUDENT_SUBJECT(ID, GRADE, STUDENT_ID, SUBJECT_ID) VALUES (4,null,7,4);
...
--SCHEDULES
INSERT INTO SCHEDULE(ID, PROFESSOR_ID, SUBJECT_ID, GROUP_ID, DAY, HOUR, ROOM) VALUES (1,2,1,1,1,10,'C11');
INSERT INTO SCHEDULE(ID, PROFESSOR_ID, SUBJECT_ID, GROUP_ID, DAY, HOUR, ROOM) VALUES (2,3,2,1,3,12,'L1');
INSERT INTO SCHEDULE(ID, PROFESSOR_ID, SUBJECT_ID, GROUP_ID, DAY, HOUR, ROOM) VALUES (3,4,4,2,5,18,'C4');

--EDUCATION_PLAN
INSERT INTO EDUCATION_PLAN(ID, GROUP_ID, PROFESSOR_ID, SUBJECT_ID, EVALUATION_METHOD) VALUES(1, 1, 2, 1, 'Evaluation method 1');
INSERT INTO EDUCATION_PLAN(ID, GROUP_ID, PROFESSOR_ID, SUBJECT_ID, EVALUATION_METHOD) VALUES(2, 1, 3, 2, 'Evaluation method 2');

INSERT INTO EDUCATION_PLAN(ID, GROUP_ID, PROFESSOR_ID, SUBJECT_ID, EVALUATION_METHOD) VALUES(3, 2, 4, 3, 'Evaluation method 3');
INSERT INTO EDUCATION_PLAN(ID, GROUP_ID, PROFESSOR_ID, SUBJECT_ID, EVALUATION_METHOD) VALUES(4, 2, 4, 4, 'Evaluation method 4');
